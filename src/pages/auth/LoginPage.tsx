      ...
      >
        <GlowCard className="overflow-hidden bg-white shadow-xl border-[#e2e8f0]">
          <div className="grid lg:grid-cols-2">
            {/* Left: Image */}
            <div className="relative hidden lg:block h-full min-h-[600px] bg-[#0f172a]">
              <img
                src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=800&h=1000&fit=crop"
                alt="Login to IronCore Gym"
              ...
              <div className="absolute bottom-12 left-12 right-12 text-white">
                ...
                <p className="text-[#cbd5e1] text-[15px] leading-relaxed">
                  Continue your fitness journey with IronCore Gym. Access your personalized workout plans, diet charts, and class schedules.
                </p>
              </div>
            </div>
            ...
            <div className="p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
              ...
              <div className="text-center lg:text-left mb-10">
                <h1 className="text-3xl font-display font-bold text-[#0f172a] mb-2">Log In</h1>
                <p className="text-[#64748b] text-[15px]">Enter your credentials to access your account</p>
              </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <label className="block text-[13px] font-bold text-[#475569]">Password</label>
                    <Link to="/forgot-password" className="text-[12px] font-bold text-[#ea580c] hover:text-[#c2410c] transition-colors">
                      Forgot Password?
                    </Link>
                  </div>
                  <div className="relative">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.99 }}
                  className="w-full btn-primary py-4 text-[15px] flex items-center justify-center gap-2 mt-4 disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
              ...
              <div className="mt-8 text-center text-[14px] text-[#64748b]">
                ...
                <Link to="/register" className="font-bold text-[#ea580c] hover:text-[#c2410c] transition-colors">
                  Join Now
                </Link>
              </div>
            </div>
